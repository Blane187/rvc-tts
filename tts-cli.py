...
if __name__ == "__main__":
    ...
    parser.add_argument("--tts_text", type=str, required=True, help="Input text for TTS")
    parser.add_argument("--tts_voice", type=str, required=True, choices=tts_voices, help="Edge-tts speaker")
    parser.add_argument("--f0_up_key", type=int, default=0, help="Transpose key")
    parser.add_argument("--f0_method", type=str, default="rmvpe", choices=["rmvpe", "crepe"], help="Pitch extraction method")
    parser.add_argument("--index_rate", type=float, default=1.0, help="Index rate")
